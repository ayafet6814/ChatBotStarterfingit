...
public class ChatBot4
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "Here! My coat is yours!";
                	emotion--;
		}
	...
	private String replyCold(String statement)
	{
		if (statement.equals("How is the weather?"))
		{
			return "The weather is very nice today.";
		}
		else if (statement.equals("how is the weather?"))
		{
			return "The weather is nice today.";
		}
		else if (statement.equals("how is the weather")) {
			return "The weather is nice man.";
		}
		return ".";
	}
